...
class School(models.Model):
    ...
    description = models.TextField( max_length=200, help_text="simple description of your school")
    about = models.TextField(help_text="detailed description of your school")
