                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <h4 class="font-weight col-auto">Habits</h4>
                                        ...
                                        <div v-for="text in attitudes[habit.key].texts" >
                                            <div class="d-flex" >
                                                <div class="col px-1" v-show="!(!editable && !text._t)">
                                                    <md-field>
                                                        <label>title</label>
                                                        <md-input v-model="text._t" :readonly="!editable"
                                                        ></md-input>
                                                    </md-field>
                                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <md-field>
                                    ...
                                    <md-textarea v-model="routine.message" md-autogrow :readonly="!editable"></md-textarea>
                                </md-field>
                            </div>
                            <div v-if="editable">
...
export default{
    name : "StudentRoutine",
    created(){
        this.fetchStudentRoutine(this.$route.params.routineId).then( routine =>{
